...
def single_run(config):
    ...
    wandb.init(
        ...
        name=f'inequity_aversion_cnn_harvest_common_closed',
        group=f'harvest_common',
    )
...
def tune(default_config):
    ...
    sweep_config = {
        ...
        "parameters": {
            ...
            "ENV_KWARGS.inequity_aversion_alpha": {"values": [100, 50, 10, 5]},
            "ENV_KWARGS.inequity_aversion_beta": {"values": [0.25]},
...
@hydra.main(version_base=None, config_path="config", config_name="inequity_aversion_cnn_harvest_common_closed")
def main(config):
    if config["TUNE"]:
        tune(config)
    else:
