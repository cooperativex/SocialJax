...
def single_run(config):
    ...
    wandb.init(
        ...
        name=f'transfer_cnn_harvest_common_partnership',
        group=f'harvest_common_partnership',
    )
...
def tune(default_config):
    ...
    sweep_config = {
        "name": "harvest_common_partnership",
        "method": "grid",
        "metric": {
...
@hydra.main(version_base=None, config_path="config", config_name="transfer_cnn_harvest_common_partnership")
def main(config):
    if config["TUNE"]:
        tune(config)
    else:
