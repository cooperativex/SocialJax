...
def single_run(config):
    ...
    wandb.init(
        ...
        name=f'transfer_cnn_harvest_partnership',
...
def tune(default_config):
    ...
    def wrapped_make_train():
        ...
        # evaluate(params, test_env, save_path, config)
...
@hydra.main(version_base=None, config_path="config", config_name="transfer_cnn_harvest_partnership")
def main(config):
    if config["TUNE"]:
        tune(config)
    else:
